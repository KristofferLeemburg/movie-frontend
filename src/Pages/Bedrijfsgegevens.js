...
function Bedrijfsgegevens() {
  return (
    <div>
        ...
        <p>Los Gatos, CA 95032, VS</p>
        
        <h3>Netflix International B.V.</h3>
        <p>Karperstraat 8-10</p>
        <p>1075 KZ Amsterdam, Nederland</p>
        <p>KvK: 62266519</p>
        <p>Btw-nummer: NL853746333B01</p>
        <p>Aandelenkapitaal: 12.500 euro</p>
        <p>E-mailadres: nl@netflix.com</p>
     </div>
  );
}
